...
function extension_install_geolocation()
{
    ...
    $commonObject -> sqlQuery(
        ...
        OSM VARCHAR(512) DEFAULT NULL,
        GOOGLE VARCHAR(512) DEFAULT NULL,
        BING VARCHAR(512) DEFAULT NULL,
        OSMOSE VARCHAR(512) DEFAULT NULL,
        HERE VARCHAR(512) DEFAULT NULL,
        SERVER_ONE VARCHAR(512) DEFAULT NULL,
        SERVER_TWO VARCHAR(512) DEFAULT NULL,
