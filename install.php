...
function extension_install_geolocation()
{
    ...
    $commonObject -> sqlQuery(
        ...
        OSMAP VARCHAR(240) DEFAULT NULL,
        GOOGLE VARCHAR(240) DEFAULT NULL,
        BING VARCHAR(240) DEFAULT NULL,
        OSMOSE VARCHAR(240) DEFAULT NULL,
        HERE VARCHAR(240) DEFAULT NULL,
        SERVER_ONE VARCHAR(240) DEFAULT NULL,
        SERVER_TWO VARCHAR(240) DEFAULT NULL,
