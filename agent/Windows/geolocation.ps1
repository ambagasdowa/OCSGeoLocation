...
#               'TIMEHOST' => {},
    ...
    $xml += "<PHONE>" + $namae + "</PHONE>`n"
    $xml += "<IMEI>" + $namae + "</IMEI>`n"
    $xml += "<ADDRESS>" + '' + "</ADDRESS>`n"
    ...
    $xml += "<ZIPCODE>" + $request.zip + "</ZIPCODE>`n"
    ...
    $xml += "<ORG>" + $request.isp + "</ORG>`n"
    $xml += "<ASLABEL>" + $request.isp + "</ASLABEL>`n"
    $xml += "<OSMAP>" + $linkOmap + "</OSMAP>`n"
    $xml += "<GOOGLE>" + $linkGoogle + "</GOOGLE>`n"
    $xml += "<BING>" + $linkGoogle + "</BING>`n"
    $xml += "<OSMOSE>" + $linkGoogle + "</OSMOSE>`n"
    $xml += "<HERE>" + $linkGoogle + "</HERE>`n"
    $xml += "<SERVER_ONE>" + $linkGoogle + "</SERVER_ONE>`n"
    $xml += "<SERVER_TWO>" + $linkGoogle + "</SERVER_TWO>`n"
